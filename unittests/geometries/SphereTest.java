...
class SphereTest {
    ...
    void testfindIntersections()
    {
        ...
        result = sphere.findIntersections(new Ray(new Point(0.42, -0.48,0.66), new Vector(3.17, 1.95,-0.66)));
        p3 = new Point(1.85,0.39,0.36);
        ...
        p1 = new Point(0.96,-1, 0);
        p2 = new Point(1.04,1, 0);
